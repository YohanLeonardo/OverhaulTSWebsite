                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-teal-100 max-w-3xl mx-auto">
                            Learn about TalentSource - Indonesia's leading
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg">
                                ...
                                <p className="text-gray-700 leading-relaxed mb-6">
                                    TalentSource is truly Indonesian Consulting
                                    and Solution company which comprises the
                                    Indonesian experienced and highly
                                    knowledgeable partners with hands-on
                                    experience and most recent techniques, ready
                                    to help companies/organizations in Indonesia
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Deep understanding of Indonesian
                                                business culture
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Successful projects with leading
                                                corporations
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <Card className="bg-white shadow-xl border-0 rounded-2xl overflow-hidden">
                                <div className="bg-gradient-to-r from-teal-600 to-blue-600 p-6 text-white">
                                    ...
                                    <p className="text-teal-100">
                                        Download our comprehensive company
                                        profile and learn more about our
                                        services
                                    </p>
                                </div>
                                ...
                                <CardContent className="p-6">
                                    ...
                                    >
                                        ...
                                        <p className="text-xs text-gray-500 text-center mt-4">
                                            ...
                                            communications from TalentSource
                            ...
                            <Card className="mt-6 bg-gradient-to-br from-gray-50 to-gray-100 border-0">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <p className="text-sm text-gray-600 mb-4">
                                        ...
                                        consultation and detailed discussions
                                        about your digital transformation needs.
                                    </p>
                                    <a
                                        href="https://wa.me/6281770237849?text=Halo, saya ingin menjadwalkan konsultasi terkait Company Profile TalentSource"
                                        target="_blank"
