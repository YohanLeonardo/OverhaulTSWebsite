        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-teal-100 max-w-3xl mx-auto">
              Meet our experienced partners who bring deep expertise and proven
              track records to drive your digital transformation success
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our standing partners combine decades of experience with
              cutting-edge expertise to deliver exceptional results for our
              clients
            </p>
          </div>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-teal-600 to-blue-600 rounded-lg p-6 text-white z-10 transform transition-all duration-300">
                    <div className="h-full flex flex-col">
                      ...
                      <div className="text-center mb-4">
                        ...
                        <p className="text-teal-100 text-sm">{partner.title}</p>
                      </div>
