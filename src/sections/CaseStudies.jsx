...
const caseStudiesData = [
    {
        ...
        link: '/Case-Study-Fraud-Detection-System-171221.pdf',
    },
    {
        id: 2,
    ...
    },
    {
        ...
        link: '/Case-Study-Pulsa-Retailer-171221.pdf',
    },
    {
        id: 4,
        ...
        link: '/Case-Study-WPSAutomation_update.pdf',
    },
    {
        id: 5,
        title: 'Work Process Automation (RPA) Awareness & Implementation',
        category: 'Process Automation & RPA',
        icon: <Settings className="h-8 w-8 text-blue-600" />,
        description:
            'Otomasi proses kerja administratif klerikal menggunakan robot software untuk menggantikan tugas repetitif seperti pengurusan invoice, P2P, dan OTC agar lebih cepat dan efisien.',
        technologies: ['RPA', 'Automation Strategy', 'Proof of Concept (POC)'],
        image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80',
        link: '/RPA-Awareness-Briefing-251121.pdf',
    },
    {
        id: 6,
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-teal-100 max-w-3xl mx-auto">
                            Discover how we've helped leading Indonesian
                            companies transform their operations through digital
                            innovation, process automation, and strategic
                            consulting.
                        </p>
                    </div>
                </div>
