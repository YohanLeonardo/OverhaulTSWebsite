...
// Tambahkan Sparkles ke daftar import
import {
    Settings,
    Brain,
    Users,
...
const servicesData = [
    // Objek Gen-AI diletakkan di urutan paling atas
    {
        icon: Sparkles,
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Comprehensive digital transformation services designed
                        to accelerate your business growth and operational
                        efficiency.
                    </p>
                </div>
