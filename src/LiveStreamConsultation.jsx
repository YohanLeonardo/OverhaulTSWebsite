...
const LiveStreamConsultation = () => {
    ...
    const handleDownload = (e, which) => {
        e.preventDefault()
        const flyerMap = {
            A: '/flyers/Final-Flyer-RPA-1-1.pdf',
            B: '/flyers/Final-Flyer-RPA-1-2.pdf',
        }
            ...
            <section className="bg-gradient-to-r from-teal-600 to-blue-600 text-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-teal-100 max-w-4xl mx-auto">
                        Livestream consultation is our unique service that
                        adopts the consultation session with independent
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-8">
                        <Card className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden">
                            <CardContent className="p-8">
                                <h2 className="text-2xl font-bold text-gray-900 mb-4">
                                    The major differences of our livestream
                                    consultation with those consultation model
                                    are:
                                </h2>
                                <ul className="space-y-3">
                                    <li className="flex items-start space-x-3">
                                        ...
                                        <span className="text-gray-700">
                                            Appointment is made a lot easier and
                                            interactive
                                        </span>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5" />
                                        <span className="text-gray-700">
                                            Our session is more structured with
                                            clear points
                                        </span>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5" />
                                        <span className="text-gray-700">
                                            Will be limited to two hours session
                                            segment
                                        </span>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5" />
                                        <span className="text-gray-700">
                                            Can be team of TS consultants on max
                                            15 participants
                                        </span>
                                    </li>
                                    <li className="flex items-start space-x-3">
                                        <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5" />
                                        <span className="text-gray-700">
                                            Dedicated sessions dealing your own
                                            issues and concerns only
                                        </span>
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden">
                            <CardContent className="p-8">
                                <h2 className="text-2xl font-bold text-gray-900 mb-4">
                                    TS memberikan layanan live stream
                                    consultation service untuk tiga topik
                                    berikut :
                                </h2>
                        ...
                        <Card className="bg-gradient-to-br from-teal-50 to-blue-50 border-0 rounded-2xl shadow-lg">
                            <CardContent className="p-8">
                                <h2 className="text-2xl font-bold text-gray-900 mb-4">
                                    Consultation service ini disesuaikan dengan
                                    kebutuhan peminat tergantung posisinya saat
                                    ini pada masing masing ketiga topik diatas:
                                </h2>
                                <ul className="list-disc list-inside text-gray-700 space-y-2">
                                    <li>
                                        Sedang akan memutuskan untuk menerapkan
                                        di organisasi / korporasi
                                    </li>
                                    <li>Saat tahap implementasi</li>
                                    <li>
                                        Sudah cukup advanced dalam implementasi
                                    </li>
                                </ul>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-white shadow-lg border-0 rounded-2xl overflow-hidden">
                            <CardContent className="p-8">
                                <p className="text-gray-700 leading-relaxed">
                                    Program ini Sebagian juga untuk mendukung
                                    free internship program TS.
                                </p>
                                <div className="mt-6">
                                    <p className="text-gray-900 font-semibold">
                                        Korporasi/ organisasi peminat dapat
                                        menyatakan minat melalui
                                    </p>
                    ...
                    <div className="lg:sticky lg:top-8 space-y-6">
                        ...
                        <Card className="bg-white shadow-xl border-0 rounded-2xl overflow-hidden">
                            <CardContent className="p-0">
                                <img src={flyer2} className="w-full h-auto" />
                                <div className="p-6">
                                    <Button
                                        onClick={() => {
                                            setSelectedFlyer('B')
                    ...
                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Fill out the form to receive the flyer.
                                </DialogDescription>
                            </DialogHeader>
                            <form
                                onSubmit={(e) =>
                                    handleDownload(e, selectedFlyer)
                                }
                                className="space-y-4"
                            >
                                <div>
